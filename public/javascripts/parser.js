...
DefaultAirThreats["Array"][0] =
    {Index = 1, Name = "${$(".iffcc_profile:eq(0) .iffcc_program-name input").val().toUpperCase()}", Wingspan = ${$(".iffcc_profile:eq(0) .iffcc_program-wingspan input").val()}, Length = ${$(".iffcc_profile:eq(0) .iffcc_program-length input").val()}, TargetSpeed = ${$(".iffcc_profile:eq(0) .iffcc_program-speed input").val()}, Selected = ${$(".iffcc_profile:eq(0) .cover").hasClass("right")}}
DefaultAirThreats["Array"][1] =
    {Index = 2, Name = "${$(".iffcc_profile:eq(1) .iffcc_program-name input").val().toUpperCase()}", Wingspan = ${$(".iffcc_profile:eq(1) .iffcc_program-wingspan input").val()}, Length = ${$(".iffcc_profile:eq(1) .iffcc_program-length input").val()}, TargetSpeed = ${$(".iffcc_profile:eq(1) .iffcc_program-speed input").val()}, Selected = ${$(".iffcc_profile:eq(1) .cover").hasClass("right")}}
DefaultAirThreats["Array"][2] =
    {Index = 3, Name = "${$(".iffcc_profile:eq(2) .iffcc_program-name input").val().toUpperCase()}", Wingspan = ${$(".iffcc_profile:eq(2) .iffcc_program-wingspan input").val()}, Length = ${$(".iffcc_profile:eq(2) .iffcc_program-length input").val()}, TargetSpeed = ${$(".iffcc_profile:eq(2) .iffcc_program-speed input").val()}, Selected = ${$(".iffcc_profile:eq(2) .cover").hasClass("right")}}
DefaultAirThreats["Array"][3] =
    {Index = 4, Name = "${$(".iffcc_profile:eq(3) .iffcc_program-name input").val().toUpperCase()}", Wingspan = ${$(".iffcc_profile:eq(3) .iffcc_program-wingspan input").val()}, Length = ${$(".iffcc_profile:eq(3) .iffcc_program-length input").val()}, TargetSpeed = ${$(".iffcc_profile:eq(3) .iffcc_program-speed input").val()}, Selected = ${$(".iffcc_profile:eq(3) .cover").hasClass("right")}}
DefaultAirThreats["Array"][4] =
    {Index = 5, Name = "${$(".iffcc_profile:eq(4) .iffcc_program-name input").val().toUpperCase()}", Wingspan = ${$(".iffcc_profile:eq(4) .iffcc_program-wingspan input").val()}, Length = ${$(".iffcc_profile:eq(4) .iffcc_program-length input").val()}, TargetSpeed = ${$(".iffcc_profile:eq(4) .iffcc_program-speed input").val()}, Selected = ${$(".iffcc_profile:eq(4) .cover").hasClass("right")}}
DefaultAirThreats["Array"][5] =
    {Index = 6, Name = "${$(".iffcc_profile:eq(5) .iffcc_program-name input").val().toUpperCase()}", Wingspan = ${$(".iffcc_profile:eq(5) .iffcc_program-wingspan input").val()}, Length = ${$(".iffcc_profile:eq(5) .iffcc_program-length input").val()}, TargetSpeed = ${$(".iffcc_profile:eq(5) .iffcc_program-speed input").val()}, Selected = ${$(".iffcc_profile:eq(5) .cover").hasClass("right")}}
DefaultAirThreats["Array"][6] =
    {Index = 7, Name = "${$(".iffcc_profile:eq(6) .iffcc_program-name input").val().toUpperCase()}", Wingspan = ${$(".iffcc_profile:eq(6) .iffcc_program-wingspan input").val()}, Length = ${$(".iffcc_profile:eq(6) .iffcc_program-length input").val()}, TargetSpeed = ${$(".iffcc_profile:eq(6) .iffcc_program-speed input").val()}, Selected = ${$(".iffcc_profile:eq(6) .cover").hasClass("right")}}
DefaultAirThreats["Array"][7] =
    {Index = 8, Name = "${$(".iffcc_profile:eq(7) .iffcc_program-name input").val().toUpperCase()}", Wingspan = ${$(".iffcc_profile:eq(7) .iffcc_program-wingspan input").val()}, Length = ${$(".iffcc_profile:eq(7) .iffcc_program-length input").val()}, TargetSpeed = ${$(".iffcc_profile:eq(7) .iffcc_program-speed input").val()}, Selected = ${$(".iffcc_profile:eq(7) .cover").hasClass("right")}}
DefaultAirThreats["Array"][8] =
    {Index = 9, Name = "${$(".iffcc_profile:eq(8) .iffcc_program-name input").val().toUpperCase()}", Wingspan = ${$(".iffcc_profile:eq(8) .iffcc_program-wingspan input").val()}, Length = ${$(".iffcc_profile:eq(8) .iffcc_program-length input").val()}, TargetSpeed = ${$(".iffcc_profile:eq(8) .iffcc_program-speed input").val()}, Selected = ${$(".iffcc_profile:eq(8) .cover").hasClass("right")}}
DefaultAirThreats["Array"][9] =
    {Index = 10, Name = "${$(".iffcc_profile:eq(9) .iffcc_program-name input").val().toUpperCase()}", Wingspan = ${$(".iffcc_profile:eq(9) .iffcc_program-wingspan input").val()}, Length = ${$(".iffcc_profile:eq(9) .iffcc_program-length input").val()}, TargetSpeed = ${$(".iffcc_profile:eq(9) .iffcc_program-speed input").val()}, Selected = ${$(".iffcc_profile:eq(9) .cover").hasClass("right")}}
